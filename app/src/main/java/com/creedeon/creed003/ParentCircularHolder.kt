...
import kotlinx.android.synthetic.main.parent_circular_holder.*


class ParentCircularHolder:AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.parent_circular_holder)

        progressDialog = ProgressDialog(this@ParentCircularHolder)
        ...
        myref.addListenerForSingleValueEvent(object: ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                file_holder_recyclerview.adapter = adapter
