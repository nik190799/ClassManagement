package com.creedeon.creed003.notepad;
...
import com.creedeon.creed003.notepad.adapters.NotesAdapter;
import com.creedeon.creed003.notepad.callbacks.MainActionModeCallback;
import com.creedeon.creed003.notepad.callbacks.NoteEventListener;
import com.creedeon.creed003.notepad.db.NotesDB;
import com.creedeon.creed003.notepad.db.NotesDao;
import com.creedeon.creed003.notepad.model.Note;
import com.creedeon.creed003.notepad.utils.NoteUtils;
...
import static com.creedeon.creed003.notepad.EditNoteActivity.NOTE_EXTRA_Key;
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        ...
                        // NoteActivity.this.recreate();

                        // this lines means wi want to close the app and open it again to change theme
                        TaskStackBuilder.create(NoteActivity.this)
                                .addNextIntent(new Intent(NoteActivity.this, NoteActivity.class))
...
//    }
    ...
    public void onNoteLongClick(Note note) {
        ...
        // set new listener to adapter intend off NoteActivity listener that we have implement
