...
public class takeAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //to get class name from Attendance
        ...
        dbuser.orderByChild("classes").equalTo(class_selected).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                    Userlist.add(Objects.requireNonNull(dsp.child("sid").getValue()).toString());
    ...
    public void showSelectedItems(View view) throws IOException, BiffException {
    ...
    public void addtoreport() throws IOException, BiffException {
        ...
        if(tomorrow.substring(0,2).equals("01")){
            ...
            for(i = 0; i<row; i++)
            {
                ...
                for (int c=0;c<col;c++)
                {
                    ...
                    xx = new StringBuilder(z.getContents());
                    if(xx.toString().equals("P"))
                        nop++;
                    if((xx.length() > 0) ||!xx.toString().equals("")) {
                        tc++;
                    }
